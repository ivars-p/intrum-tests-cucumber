...
import com.intrum.tests.constants.contactUs.RowHeadings;
...
import static com.intrum.tests.constants.contactUs.RowHeadings.CONTACT_ROW_HEADING;
import static com.intrum.tests.constants.navigation.Urls.CONTACT_US_PAGE_URL;
import static com.intrum.tests.constants.navigation.PageTitles.CONTACT_US_PAGE_TITLE;
...
public class ContactUsPage extends BasePage {
    ...
    public ContactUsPage startContactUsPageTest() {
        ...
        getBrowser().get(getCONFIG().getDefaultIntrumLatviaUrl() + (CONTACT_US_PAGE_URL));
    ...
    public List<ContactUsRow> getPageRows() {
        return getBrowser().findElements(PAGE_ROWS)
                .stream()
